...
class AbsentStudentSOController extends Controller
{
    ...
    public function index()
    {
        ...
        if(session()->exists('username')){
            ...
            return view('AbsentStudentSO', compact('students', 'absentsStructured','search_results_available'));
    ...
    public function search(Request $request)
    {
        ...
        return view('AbsentStudentSO', compact('absentStudents', 'students', 'search_results_available','absentsStructured'));
    }
}
