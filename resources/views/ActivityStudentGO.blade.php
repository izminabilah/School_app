    ...
    <div>
        <div class="relative rounded-t-md bg-primary-light bg-[url('/assets/images/knowledge/pattern.png')] bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
            ...
            <div class="relative">
                ...
                <form action="{{ route('search-activity-go') }}" method="GET" class="mb-6">
                    <div class="relative mx-auto max-w-[580px]">
                        <input type="text" placeholder="Input your class" class="form-input py-3 ltr:pr-[100px] rtl:pl-[100px]" id="search-activity-go"  name="search-activity-go">
