    ...
    <div>
        <div class="relative rounded-t-md bg-primary-light bg-[url('/assets/images/knowledge/pattern.png')] bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
            ...
            <div class="relative">
                ...
                <form action="{{ route('search-schedule-go') }}" method="GET" class="mb-6">
                    <div class="relative mx-auto max-w-[580px]">
                        <input type="text" placeholder="Input your class" class="form-input py-3 ltr:pr-[100px] rtl:pl-[100px]" id="search-schedule-go"  name="search-schedule-go">
                    ...
                    <div class="fixed inset-0 bg-[black]/60 z-[999] overflow-y-auto hidden" id="form-add-schedule">
                        <div class="flex items-center justify-center min-h-screen px-4">
                            <div class="panel border-0 p-0 rounded-lg overflow-hidden md:w-full max-w-lg w-[90%] my-8">
                                ...
                                >Add Schedule</h3>
                                <div class="p-5">
                                    <form action="/go/Schedule/add" method="POST">
                                        @csrf
                                        <div class="mb-5">
                                        ...
                                        <div class="flex justify-end items-center mt-8">
                                            <button type="button" class="btn btn-outline-danger"
                                                    onclick="location.href='/go/Schedule'">Cancel</button>
                            ...
                            <tr>
                                ...
                                <td class="border-2">
                                    <div class="flex gap-4 items-center justify-center">
                                        <a type="button" class="btn btn-sm btn-outline-primary" href="{{route('edit-schedule-go', ['id' => $subjectSchedule->id])}}">Edit</a>
                                        <a type="button" class="btn btn-sm btn-outline-danger" href="{{route('delete-schedule-go', ['id' => $subjectSchedule->id])}}">Delete</a>
                                    </div>
                                </td>
                            </tr>
                        @empty
