                    ...
                    <form name="form-edit" method="POST" action={{route('update-account-tea', ['id' => $accountTeachers->id])}}>
                        ...
                        <div class="mb-5">
                            ...
                            <input id="name" name="name" type="text" placeholder="Enter Name"
                                   class="form-input" value="{{$accountTeachers->name}}"/>
                        </div>
                        <div class="mb-5">
                            <label for="username">Username</label>
                            <input id="username" name="username" type="text" placeholder="Enter Username"
                                   class="form-input" value="{{$accountTeachers->username}}"/>
                        </div>
                        <div class="mb-5">
                            <label for="password">Password</label>
                            <input id="password" name="password" type="text" placeholder="Enter Password"
                                   class="form-input" value="{{$accountTeachers->password}}"/>
                        </div>
                        <div class="flex justify-end items-center mt-8">
                            <a type="button" class="btn btn-outline-danger" href="{{route('account-teacher')}}">Cancel</a>
