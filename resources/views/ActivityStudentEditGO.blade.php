                    ...
                    <div class="fixed inset-0 bg-[black]/60 z-[999] overflow-y-auto " id="form-add-activity">
                        <div class="flex items-center justify-center min-h-screen px-4">
                            <div class="panel border-0 p-0 rounded-lg overflow-hidden md:w-full max-w-lg w-[90%] my-8">
                                ...
                                >Edit aktivitas</h3>
                                <div class="p-5">
                                    <form name="form-edit" method="POST" action="{{ route('update-aktivitas-go', ['id' => $activityStudents->id]) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="mb-5">
                            ...
                            <tr>
                                ...
                                <td class="border-2">
                                    <div class="flex gap-4 items-center justify-center">
                                        <a type="button" class="btn btn-sm btn-outline-primary" href="{{ route('edit-aktivitas-go', ['id' => $activityStudents->id]) }}">Edit</a>
