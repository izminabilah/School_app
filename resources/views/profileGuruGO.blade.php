    ...
    <div x-data="contacts">
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                        ...
                        <div class="fixed inset-0 bg-[black]/60 z-[999] overflow-y-auto hidden"
                            ...
                            <div class="flex items-center justify-center min-h-screen px-4"
                                ...
                                <div x-show="addContactModal" x-transition x-transition.duration.300
                                    ...
                                    <div class="p-5">
                                        <form action="/go/profile/teacher/add" method="POST">
                                            @csrf
                                            <div class="mb-5">
                ...
                <div class="relative ">
                    <!-- searchbar -->
                    <form class="mx-auto w-full" action="{{ route('search-profile-tea-go') }}" method="GET">
                        <div class="relative">
                            <input type="text" placeholder="Search Profile" class="form-input py-2 ltr:pr-11 rtl:pl-11 peer" id="search-tea-go"  name="search-tea-go" oninput="this.form.submit()"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex gap-4 items-center justify-center">
                                        <a type="button" class="btn btn-sm btn-outline-primary" href="{{route('edit-profile-tea-go', ['id' => $profileTeacher->id])}}">Edit</a>
                                        <a type="button" class="btn btn-sm btn-outline-danger" href="{{route('delete-profile-tea-go', ['id' => $profileTeacher->id])}}">Delete</a>
                                    </div>
                                </td>
                            </tr>
                        @empty
