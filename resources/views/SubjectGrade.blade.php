            ...
            <div class="relative">
                <div class="flex flex-col items-center justify-center sm:-ms-32 sm:flex-row xl:-ms-60">
                    ...
                    <div class="me-4 ms-2 hidden sm:block text-[#0E1726] dark:text-white  rtl:rotate-y-180">
                        <svg width="111" height="22" viewBox="0 0 116 22" fill="none" xmlns="http://www.w3.org/2000/svg"
                             class="w-16 xl:w-28">
                            <path
                    ...
                    <div class="mb-2 text-center text-xl font-bold dark:text-white md:text-3xl">Ingin tahu Nilai Siswa?
                    </div>
                </div>
                <p class="mb-9 text-center text-base font-semibold">Masukkan mata pelajaran untuk melihat nilai siswa</p>
                <form action="{{ route('search-subject') }}" method="GET" class="mb-16">
                    <div class="relative mx-auto max-w-[580px]">
                        <input type="text" placeholder="Masukkan mata pelajaran"
                               class="form-input py-3 ltr:pr-[100px] rtl:pl-[100px]" id="search-subject"
                               name="search-subject">
        ...
        <div class="panel" @if($search_results_available) @else hidden @endif id="tables-grade">
            <div class="panel">
                <div class="flex items-center justify-between flex-wrap mb-5 ">
                    <h5 class="font-semibold text-lg dark:text-white-light">Nilai Mata Pelajaran {{$nama_subject}} </h5>
