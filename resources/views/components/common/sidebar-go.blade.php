            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'activity'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/go/activity/student">Aktivitas siswa</a>
                        </li>
                        <li>
                            <a href="/go/activity/absent">Absen</a>
                        </li>
                        <li>
                            <a href="/go/activity/subject/grade">Nilai Mapel</a>
                        </li>
                    </ul>
                </li>
