                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'dashboard' }"
                        ...
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Create Account
                            </span>
                        </div>
                ...
                <li class="menu nav-item">
                    <a href="/profile/teacher">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Profile Teacher</span>
                        </div>
                    </a>
                </li>
                <li class="menu nav-item">
                    <a href="/users/profile">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Subject Schedule</span>
                        </div>
                    </a>
                </li>
                ...
                <li class="menu nav-item">
                    <a href="/calender/semester">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Calender Semester</span>
                        </div>
                    </a>
                </li>
                ...
                <li class="menu nav-item">
                    <a href="/payment">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Payment Validation</span>
                        </div>
                    </a>
                </li>
