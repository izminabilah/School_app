    ...
    <div x-data="contacts">
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                ...
                <div class="relative ">
                    <!-- searchbar -->
                    <form class="mx-auto w-full" action="{{ route('search-profile-tea-po') }}" method="GET">
                        <div class="relative">
                            <input type="text" placeholder="Search Profile" class="form-input py-2 ltr:pr-11 rtl:pl-11 peer" id="search-tea-po"  name="search-tea-po" oninput="this.form.submit()"/>
