                    ...
                    <div class="flex items-center justify-center min-h-screen px-4">
                        <div class="panel border-0 p-0 rounded-lg overflow-hidden md:w-full w-[90%] my-8">
                            ...
                            <div class="p-5">
                                ...
                                <form name="form-edit" method="POST" action="{{route('update-grade-go', ['id' => $subjectGrade->id])}}">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-5">
                                    ...
                                    <div class="flex justify-end items-center mt-8">
                                        <button type="button" class="btn btn-outline-danger" onclick="location.href='/go/activity/subject/grade'">Cancel</button>
