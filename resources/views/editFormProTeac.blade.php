    ...
    <div class="fixed inset-0 bg-[black]/60 z-[999] overflow-y-auto " :class="addContactModal && '!block'">
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="panel border-0 p-0 rounded-lg md:w-full max-w-lg w-[90%] my-8">
                ...
                <h3 class="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">Edit Profile Teacher</h3>
                <div class="p-5">
                    <form name="form-edit" method="POST" action={{route('update-profile-tea', ['id' => $profileTeachers->id])}}>
                        @csrf
                        @method('PUT')
                        <div class="mb-5">
                        ...
                        <div class="flex justify-end items-center mt-8">
                            <a type="button" class="btn btn-outline-danger" href="{{route('profile-teacher')}}">Cancel</a>
