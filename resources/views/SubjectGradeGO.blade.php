        ...
        <div class="relative rounded-t-md bg-primary-light bg-[url('/assets/images/knowledge/pattern.png')] bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
            ...
            <div class="relative">
                <div class="flex flex-col items-center justify-center sm:-ms-32 sm:flex-row xl:-ms-60">
                    ...
                    <div class="mb-2 text-center text-xl font-bold dark:text-white md:text-3xl">Nilai Akademik Siswa</div>
                </div>
                <p class="mb-9 text-center text-base font-semibold">Cari nilai mata pelajaran</p>
                <form action="{{ route('search-subject-go') }}" method="GET" class="mb-6">
                    <div class="relative mx-auto max-w-[580px]">
                        <input type="text" placeholder="masukkan mata pelajaran" class="form-input py-3 ltr:pr-[100px] rtl:pl-[100px]" id="search-subject-go"  name="search-subject-go">
