    ...
    <div>
        <div class="relative rounded-t-md bg-[url('/assets/images/visi-misi.png')] bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
            ...
            <div class="relative">
                ...
                <p class="mb-9 text-center text-base font-semibold">Masukkan kelas untuk melihat aktivitas siswa</p>
                <form action="{{ route('search-activity') }}" method="GET" class="mb-16">
                    <div class="relative mx-auto max-w-[580px]">
                        <input type="text" placeholder="Masukkan Kelas" class="form-input py-3 ltr:pr-[100px] rtl:pl-[100px]" id="search-activity"  name="search-activity">
        ...
        <div class="panel" @if($search_results_available) @else hidden @endif" id= "tables-activity">
            <div class="panel">
                <div class="flex items-center justify-between mb-5 ">
                    <h5 class="font-semibold text-lg dark:text-white-light">Aktivitas Siswa ( {{$nama_class}} )</h5>
