        ...
        <div class="relative rounded-t-md bg-[url('/assets/images/visi-misi.png')] bg-contain bg-left-top bg-no-repeat px-5 py-10 dark:bg-black md:px-10">
            ...
            <div class="relative">
                <div class="flex flex-col items-center justify-center sm:-ms-32 sm:flex-row xl:-ms-60">
                    ...
                    <div class="mb-2 text-center text-xl font-bold dark:text-white md:text-3xl">Ingin tahu Jadwalmu?</div>
                </div>
                <p class="mb-9 text-center text-base font-semibold">Masukkan kelasmu</p>
                <form action="{{ route('search-schedule-so') }}" method="GET" class="mb-16">
                    <div class="relative mx-auto max-w-[580px]">
                        <input type="text" placeholder="masukkan kelasmu" class="form-input py-3 ltr:pr-[100px] rtl:pl-[100px]" id="search-schedule-so"  name="search-schedule-so">
